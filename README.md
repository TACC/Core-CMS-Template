...
[core-cms-template-setup]: https://github.com/TACC/Core-CMS-Template/blob/v0.3.2/docs/create-project.md#set-up-project
[core-cms-template-start]: https://github.com/TACC/Core-CMS-Template/blob/v0.3.2/docs/start-project.md#start-project
[core-cms-template-docs]: https://github.com/TACC/Core-CMS-Template/blob/v0.3.2/docs/README.md#tacc-custom-cms
